...
- A secure password
- Your name and optional profile information

You may also register using third-party authentication services (Apple Sign In, Google Sign In).
...
All content provided in the App, including but not limited to:
- Lessons, quizzes, and educational materials
...
You may have the ability to submit content such as:
- Profile information and photos
- Feedback and suggestions
- User reviews or comments (if applicable)

By submitting content, you grant us a worldwide, non-exclusive, royalty-free license to use, reproduce, modify, and display such content in connection with the App.
...
- **Billing**: You will be charged the subscription fee at the beginning of each billing period
- **Auto-renewal**: Subscriptions automatically renew unless canceled at least 24 hours before the end of the current period
- **Cancellation**: You may cancel your subscription at any time through your device's subscription settings
- **Refunds**: Refunds are handled according to Apple App Store or Google Play Store policies

### Price Changes

We reserve the right to change subscription prices with at least 30 days' notice. Continued use after a price change constitutes acceptance of the new price.
...
If you provide feedback or suggestions about the App, we may use such feedback without any obligation to you.

## 8. Privacy

Your privacy is important to us. Our collection and use of personal information is governed by our [Privacy Policy](./privacy-policy.md). By using the App, you consent to our privacy practices.

## 9. Third-Party Services

The App may integrate with third-party services (e.g., Supabase, Google Sign-In, Apple Sign In). Your use of these services is subject to their respective terms and privacy policies. We are not responsible for third-party services.

## 10. Disclaimers

### Educational Content

The App provides sports education and entertainment. While we strive for accuracy:
- Content is for informational purposes only
- We do not guarantee the accuracy, completeness, or timeliness of content
- Content should not be relied upon for professional or competitive purposes
...
These Terms are governed by the laws of Minnesota, USA, without regard to conflict of law principles.
...
- Sections of these Terms that should survive (e.g., disclaimers, limitations of liability) will remain in effect
...
- **Address**: 2900 Thomas Ave S, Apt. 1625, Minneapolis, MN, 55416
