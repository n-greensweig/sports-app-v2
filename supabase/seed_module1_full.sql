...
INSERT INTO lessons (id, module_id, title, description, order_index, est_minutes, xp_award, is_locked, created_at, updated_at)
VALUES ('00000001-0000-0000-0000-000000000002', '11111111-1111-1111-1111-111111111111', 'Understanding Downs', 'Learn how the down system works and why it matters', 2, 5, 80, false, now(), now())
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, description = EXCLUDED.description, est_minutes = EXCLUDED.est_minutes;
  -- Item 1
  INSERT INTO items (id, lesson_id, type, base_prompt, answer_schema_json, difficulty, status, author_id, created_at, updated_at)
...
INSERT INTO lessons (id, module_id, title, description, order_index, est_minutes, xp_award, is_locked, created_at, updated_at)
VALUES ('00000001-0000-0000-0000-000000000003', '11111111-1111-1111-1111-111111111111', 'Scoring Points', 'Learn all the ways teams can score in football', 3, 4, 80, false, now(), now())
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, description = EXCLUDED.description, est_minutes = EXCLUDED.est_minutes;
  -- Item 1
  INSERT INTO items (id, lesson_id, type, base_prompt, answer_schema_json, difficulty, status, author_id, created_at, updated_at)
...
INSERT INTO lessons (id, module_id, title, description, order_index, est_minutes, xp_award, is_locked, created_at, updated_at)
VALUES ('00000001-0000-0000-0000-000000000004', '11111111-1111-1111-1111-111111111111', 'Basic Positions - Offense', 'Learn the key offensive positions and their roles', 4, 5, 80, false, now(), now())
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, description = EXCLUDED.description, est_minutes = EXCLUDED.est_minutes;
  -- Item 1
  INSERT INTO items (id, lesson_id, type, base_prompt, answer_schema_json, difficulty, status, author_id, created_at, updated_at)
...
INSERT INTO lessons (id, module_id, title, description, order_index, est_minutes, xp_award, is_locked, created_at, updated_at)
VALUES ('00000001-0000-0000-0000-000000000005', '11111111-1111-1111-1111-111111111111', 'Basic Positions - Defense', 'Learn the key defensive positions and their roles', 5, 5, 80, false, now(), now())
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, description = EXCLUDED.description, est_minutes = EXCLUDED.est_minutes;
  -- Item 1
  INSERT INTO items (id, lesson_id, type, base_prompt, answer_schema_json, difficulty, status, author_id, created_at, updated_at)
...
INSERT INTO lessons (id, module_id, title, description, order_index, est_minutes, xp_award, is_locked, created_at, updated_at)
VALUES ('00000001-0000-0000-0000-000000000006', '11111111-1111-1111-1111-111111111111', 'The Field & Yard Lines', 'Understand the football field layout and how to read yard lines', 6, 4, 80, false, now(), now())
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, description = EXCLUDED.description, est_minutes = EXCLUDED.est_minutes;
  -- Item 1
  INSERT INTO items (id, lesson_id, type, base_prompt, answer_schema_json, difficulty, status, author_id, created_at, updated_at)
...
INSERT INTO lessons (id, module_id, title, description, order_index, est_minutes, xp_award, is_locked, created_at, updated_at)
VALUES ('00000001-0000-0000-0000-000000000007', '11111111-1111-1111-1111-111111111111', 'Game Clock & Quarters', 'Learn how time works in football games', 7, 4, 80, false, now(), now())
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, description = EXCLUDED.description, est_minutes = EXCLUDED.est_minutes;
  -- Item 1
  INSERT INTO items (id, lesson_id, type, base_prompt, answer_schema_json, difficulty, status, author_id, created_at, updated_at)
...
INSERT INTO lessons (id, module_id, title, description, order_index, est_minutes, xp_award, is_locked, created_at, updated_at)
VALUES ('00000001-0000-0000-0000-000000000008', '11111111-1111-1111-1111-111111111111', 'Common Penalties', 'Learn the most common penalties and what they mean', 8, 5, 80, false, now(), now())
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, description = EXCLUDED.description, est_minutes = EXCLUDED.est_minutes;
  -- Item 1
  INSERT INTO items (id, lesson_id, type, base_prompt, answer_schema_json, difficulty, status, author_id, created_at, updated_at)
...
INSERT INTO lessons (id, module_id, title, description, order_index, est_minutes, xp_award, is_locked, created_at, updated_at)
VALUES ('00000001-0000-0000-0000-000000000009', '11111111-1111-1111-1111-111111111111', 'Kickoffs & Returns', 'Learn how games and halves start with kickoffs', 9, 4, 80, false, now(), now())
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, description = EXCLUDED.description, est_minutes = EXCLUDED.est_minutes;
  -- Item 1
  INSERT INTO items (id, lesson_id, type, base_prompt, answer_schema_json, difficulty, status, author_id, created_at, updated_at)
...
INSERT INTO lessons (id, module_id, title, description, order_index, est_minutes, xp_award, is_locked, created_at, updated_at)
VALUES ('00000001-0000-0000-0000-000000000010', '11111111-1111-1111-1111-111111111111', 'Fumbles & Turnovers', 'Learn how possession can change during a play', 10, 4, 80, false, now(), now())
ON CONFLICT (id) DO UPDATE SET title = EXCLUDED.title, description = EXCLUDED.description, est_minutes = EXCLUDED.est_minutes;
  -- Item 1
  INSERT INTO items (id, lesson_id, type, base_prompt, answer_schema_json, difficulty, status, author_id, created_at, updated_at)
